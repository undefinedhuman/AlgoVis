package de.undefinedhuman.algovis.gui.transforms;
...
import de.undefinedhuman.algovis.gui.transforms.offset.Offset;
...
public class GuiTransform {
    ...
    public GuiTransform setParent(GuiTransform parent) {
        this.parent = parent;
        return this;
    }
